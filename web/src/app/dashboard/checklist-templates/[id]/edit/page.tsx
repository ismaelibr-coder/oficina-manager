...
export default function EditChecklistTemplatePage() {
    ...
    const loadTemplate = async () => {
        try {
            setLoading(true)
            const data = await checklistTemplatesService.getById(id)
            setFormData({
                name: data.name,
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            await checklistTemplatesService.update(id, {
                name: formData.name,
            ...
            <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="flex gap-4 pt-4">
                        <button type="submit" disabled={saving} className="flex-1 bg-primary-600 text-white py-3 px-4 rounded-lg hover:bg-primary-700 disabled:opacity-50 font-medium">
