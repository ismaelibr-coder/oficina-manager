                        ...
                        <div>
                            ...
                            <div className="flex flex-wrap gap-3">
                                ...
                                {item.photos?.map((photoUrl, index) => (
                                    <div key={index} className="relative w-24 h-24 sm:w-28 sm:h-28 rounded-lg overflow-hidden border-2 border-gray-200 group">
                                        <button
                                        ...
                                        <button
                                            onClick={async (e) => {
                                                ...
                                                if (confirm('Excluir esta foto?')) {
                                                    try {
                                                        ...
                                                        await checklistsService.updateItem(item.id, { photos: newPhotos });
                                                        if (checklist) {
                                                            setChecklist({
                                                                ...checklist,
                                                                items: checklist.items.map(i => i.id === item.id ? { ...i, photos: newPhotos } : i)
                                                            });
                                                        }
                                                    } catch (err: any) {
                                            ...
                                            className="absolute top-1 right-1 w-7 h-7 bg-red-600 hover:bg-red-700 text-white rounded-full flex items-center justify-center shadow-lg opacity-0 group-hover:opacity-100 transition-opacity z-10"
                                            title="Excluir foto"
                                        >
